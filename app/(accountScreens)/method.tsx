...
export default function Method() {
    ...
    const onAddMoney = () => {
        router.push('/(accountScreens)/payment')
    };
            ...
            <View style={{ marginHorizontal: 16 }}>
                ...
                <Pressable style={styles.cardRow} onPress={onSelectCard}>
                    <View style={styles.mcWrap}>
                        <Image source={require('../../assets/images/Hostel/paypal.png')} style={{ height: 32, width: 32 }} />
                    </View>
                    {/* <Text style={styles.cardRowText}>**** **** **76 3054</Text> */}
                </Pressable>
                <Pressable style={[styles.cardRow, { backgroundColor: '#0A051F' }]} onPress={onSelectCard}>
                    <View style={styles.mcWrap}>
                        <Image source={require('../../assets/images/Hostel/master.png')} style={{ height: 32, width: 32 }} />
                    </View>
                    <Text style={[styles.cardRowText, { color: '#fff' }]}>**** **** **76 3054</Text>
                </Pressable>
                <Pressable style={styles.cardRow} onPress={onSelectCard}>
                    <View style={styles.mcWrap}>
                        <Image source={require('../../assets/images/Hostel/visa1.png')} style={{ height: 32, width: 32 }} />
                    </View>
                    {/* <Text style={styles.cardRowText}>**** **** **76 3054</Text> */}
                </Pressable>
                ...
                <Pressable style={styles.cardRow} onPress={onSelectCard}>
                    <View style={styles.mcWrap}>
                        <Image source={require('../../assets/images/Hostel/stripe.png')} style={{ height: 32, width: 32 }} />
                    </View>
                    {/* <Text style={styles.cardRowText}>**** **** **76 3054</Text> */}
                </Pressable>
...
const styles = StyleSheet.create({
    ...
    cardTitle: { textAlign: "center", fontSize: 14, fontFamily:fonts.interMedium, color: Colors.title },
    cardSub: { textAlign: "center", fontSize: 12, color: Colors.grey, marginTop: 2, fontFamily:fonts.interMedium },
    bigAmount: {
        textAlign: "center",
        fontSize: 30,
    ...
    quickText: { fontFamily:fonts.interMedium, color: Colors.title, fontSize: 12 },
    ...
    headerTitle: { fontSize: 18,  fontFamily:fonts.interSemibold, marginLeft: 16, color: "#000" }
});
