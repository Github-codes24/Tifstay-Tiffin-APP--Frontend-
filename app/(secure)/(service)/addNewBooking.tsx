...
console.log(bookingData)
  ...
  const handleSave = async () => {
    ...
    if ((!isBreakfastDone || !isLunchDone || !isDinnerDone) && !description.trim()) {
      Alert.alert("Required", "Please provide a reason for meals not delivered");
      return;
    }
...
console.log(response)
      ...
      if (response.ok) {
        Alert.alert(
          "Success",
          "Order summary saved successfully",
          [
            {
              text: "OK",
              onPress: () => router.back()
    ...
    <View style={styles.flex}>
      ...
      >
        <>
          ...
          />
          <View style={{ borderColor: 'grey', borderWidth: 0.5, padding: 16, borderRadius: 12 }}>
...
const styles = StyleSheet.create({
  ...
  descContainer: { marginTop: 20, paddingHorizontal: 0, backgroundColor: 'white' },
  ...
  inputContainer: { marginTop: 12, paddingHorizontal: 0, backgroundColor: 'white' },
  textAreaInput: {
    textAlignVertical: "top",
    fontSize: 13,
    lineHeight: 20,
